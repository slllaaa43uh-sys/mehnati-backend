...
- احمل نسخة من السيرة والأوراق.`
  },
  {
    ...
    answer: `ميزة تمييز الإعلان ببساطة تساعدك على الحصول على نتائج أفضل من النشر العادي. وهي تهدف إلى:
- زيادة ظهور المنشور أمام الباحثين أو المهتمين بسرعة أكبر.
- تحسين فرص تفاعل المستخدمين مع إعلانك والوصول إلى جمهور أوسع.
- إبراز الإعلان في الصفحة بطريقة تلفت الانتباه وتزيد احتمال مشاهدته والتواصل.
باختصار: التمييز يجعل إعلانك أوضح ويزيد فرص الحصول على استجابة أسرع دون استخدام مصطلحات فنية.`
  },
  {
    name: 'قصص مهنية',
  ...
  },
  {
    ...
    answer: `نعم، التطبيق في تطور مستمر وسيتم إضافة ميزات تدريجيًا في التحديثات القادمة.`
  },
  // تعليمات "كيفية إنشاء منشور" (فصحى مختصرة)
  {
  ...
  // إجابة عن سبب ظهور الوظائف العالمية بالإنجليزية
  {
    ...
    answer: `تظهر بعض الوظائف باللغة الإنجليزية لأن المصدر الأصلي لها باللغة الإنجليزية. يمكنك استخدام ميزة الترجمة المتاحة في التطبيق لعرض الوظائف باللغة العربية، وسيتم عرضها تلقائيًا إذا لم تتوفر النسخة العربية.`
  },
  // صفحة الوظائف المستعجلة
  {
    name: 'صفحة الوظائف المستعجلة',
    keywords: [
      'صفحة الوظائف المستعجلة',
      'ما هي صفحة الوظائف المستعجلة',
      'ماذا تقدم صفحة الوظائف المستعجلة',
      'الوظائف المستعجلة',
      'صفحة المستعجل'
    ],
    answer: `صفحة الوظائف المستعجلة مخصصة للفرص الفورية ومطلوبة الآن، حيث تعرض وظائف بعقود مؤقتة ودفع يومي. هذه الصفحة تساعد الباحثين عن عمل في الحصول على فرص عمل سريعة دون انتظار طويل، وتتيح لهم التواصل مباشرة مع أصحاب العمل أو المنشورات المتعلقة بهذه الوظائف.
نقاط إضافية:
- تظهر الوظائف بحسب الوقت الفعلي لنشرها.
- لا تحتوي على فلترة معقدة؛ الهدف منها السرعة في الوصول للفرص.
- كل وظيفة تتضمن معلومات أساسية مثل المسمى الوظيفي، الدولة، طريقة التواصل، ونوع العقد.`
  },
  // كيفية تسجيل الخروج
  {
    name: 'كيفية تسجيل الخروج',
    keywords: ['كيفية تسجيل الخروج', 'كيف اسجل الخروج', 'كيف أسجل الخروج', 'تسجيل الخروج', 'logout'],
    answer: `1) ادخل إلى أيقونة الإعدادات في التطبيق.
2) اضغط على الحساب، وهو القائمة التي تحتوي على اسمك وبريدك الإلكتروني.
3) سيظهر لك الملف الشخصي الخاص بك.
4) انظر إلى الأعلى في الزاوية اليسرى، ستجد أيقونة ثلاث النقاط ⋮.
5) اضغط عليها، ستظهر لك الخيارات التالية: تسجيل الخروج، حذف الحساب، إلغاء.
6) اختر تسجيل الخروج لإتمام العملية.
ملاحظة: هذه خطوات إرشادية فقط؛ لا يتم تنفيذ أي إجراء نيابةً عنك.`
  },
  // جديد: استجابة عن النصب والاحتيال
  {
    name: 'النصب والاحتيال - أمن التطبيق',
    keywords: [
      'نصب', 'احتيال', 'هل هناك نصب', 'هل هناك احتيال',
      'هل الوظائف مزيفة', 'وظائف مزيفة', 'نصب في التطبيق', 'احتيال في التطبيق'
    ],
    answer: `اطمئن، التطبيق يوفر وظائف حقيقية لكن يجب توخي الحذر دائمًا عند التعامل مع أي فرصة عمل.
- لا تقم بدفع أي مبالغ مالية مقابل التقديم أو التواصل مع أي صاحب عمل.
- تحقق دائمًا من هوية صاحب الإعلان أو الجهة المعلنة قبل إرسال أي بيانات شخصية.
- استخدم ميزات التطبيق الرسمية فقط، ولا تعتمد على أي وسيلة خارج التطبيق للتقديم أو الدفع.
- إذا لاحظت أي سلوك مشبوه أو إعلان مريب، تجاهله ولا تتفاعل معه.
ملاحظة: هذه نصائح إرشادية فقط؛ لا يُتخذ أي إجراء نيابةً عنك، ولا تُذكر أو تُحيل إلى وسائل تواصل خارج التطبيق.`
  }
];
...
// ============================================
// مواضيع واجهة التطبيق (تعليمات UI) — نتحقق منها بعد LOCAL_RESPONSES
// ============================================
